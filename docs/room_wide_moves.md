...
| Silver Wind | Bug | 12 | Damages all enemies, chance to raise all user's stats |
...
### MOVE_RANGE_ROOM_ALLIES (8 moves)
...
| Agility | Psychic | 2 | Raises Speed of all allies |
...
### MOVE_RANGE_ROOM_EXCEPT_USER (2 moves)
...
- **Heat Wave** (Power 10) and **Silver Wind** (Power 12) are the strongest room-wide damaging moves
...
### Stat Modification
- **Agility** and **Speed Boost** raise Speed for all allies
...
3. **Team support** - Agility, Aromatherapy, and Safeguard keep your entire team buffed or healed
