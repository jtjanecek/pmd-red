...
// gen 4 onwards
#define MOVE_SUCKER_PUNCH 0x19D
#define MOVE_ELECTROWEB 0x19E
#define MOVE_DARK_PULSE 0x19F
#define MOVE_CLOSE_COMBAT 0x1A0
#define MOVE_AURA_SPHERE 0x1A1
#define MOVE_BUG_BUZZ 0x1A2


#define NUM_REGULAR_MOVE_IDS (MOVE_BUG_BUZZ + 1)

// special move effects derived from regular moves
// e.g. second turn of a multi-turn move
#define MOVE_UNK_19D 0x1A3 // Unused
#define MOVE_WEATHER_BALL_SUNNY 0x1A4
#define MOVE_WEATHER_BALL_RAIN 0x1A5
#define MOVE_WEATHER_BALL_HAIL 0x1A6
#define MOVE_WEATHER_BALL_SANDSTORM 0x1A7
#define MOVE_DIG_2ND_TURN 0x1A8
#define MOVE_RAZOR_WIND_2ND_TURN 0x1A9
#define MOVE_FOCUS_PUNCH_2ND_TURN 0x1AA
#define MOVE_SKY_ATTACK_2ND_TURN 0x1AB
#define MOVE_SOLARBEAM_2ND_TURN 0x1AC
#define MOVE_FLY_2ND_TURN 0x1AD
#define MOVE_DIVE_2ND_TURN 0x1AE
#define MOVE_BOUNCE_2ND_TURN 0x1AF
#define MOVE_SKULL_BASH_2ND_TURN 0x1B0
#define MOVE_CURSE_GHOST 0x1B1
#define MOVE_SNORE_ATTACK 0x1B2
#define MOVE_SLEEP_TALK_ATTACK 0x1B3
