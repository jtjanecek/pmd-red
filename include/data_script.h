...
#define SPECIAL_TEXT_TYPE_SELECTION 0x2F
#define SPECIAL_TEXT_MOVE_DELETER 0x30
#define SPECIAL_TEXT_GENGAR_HINT 0x31
#define SPECIAL_TEXT_SKARMORY_RECRUIT 0x32
