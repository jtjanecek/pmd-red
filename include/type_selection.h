...
#define TYPE_SELECTION_MOVESET_VARIANTS 2
...
typedef enum
{
    TYPE_MOVESET_NON_NIGHTMARE = 0,
    TYPE_MOVESET_NIGHTMARE = 1,
} TypeMovesetVariant;
...
typedef struct TypeBossPool
{
    ...
    u16 moves[TYPE_SELECTION_MOVESET_VARIANTS][TYPE_SELECTION_MAX_BOSSES_PER_TYPE][MAX_MON_MOVES];
    u16 minionMoves[TYPE_SELECTION_MOVESET_VARIANTS][TYPE_SELECTION_MAX_BOSSES_PER_TYPE][TYPE_SELECTION_MINIONS_PER_BOSS][MAX_MON_MOVES];
    bool8 hasCustomMoves[TYPE_SELECTION_MOVESET_VARIANTS][TYPE_SELECTION_MAX_BOSSES_PER_TYPE];
    bool8 minionHasCustomMoves[TYPE_SELECTION_MOVESET_VARIANTS][TYPE_SELECTION_MAX_BOSSES_PER_TYPE][TYPE_SELECTION_MINIONS_PER_BOSS];
    u8 bossStatTiers[TYPE_SELECTION_MAX_BOSSES_PER_TYPE][TYPE_SELECTION_STAT_COUNT];
    u8 minionStatTiers[TYPE_SELECTION_MAX_BOSSES_PER_TYPE][TYPE_SELECTION_MINIONS_PER_BOSS][TYPE_SELECTION_STAT_COUNT];
    u8 count;
} TypeBossPool;
