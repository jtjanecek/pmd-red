...
typedef struct TypeBossPool
{
    ...
    u16 minionMoves[TYPE_SELECTION_MAX_BOSSES_PER_TYPE][TYPE_SELECTION_MINIONS_PER_BOSS][MAX_MON_MOVES];
    bool8 hasCustomMoves[TYPE_SELECTION_MAX_BOSSES_PER_TYPE];
    bool8 minionHasCustomMoves[TYPE_SELECTION_MAX_BOSSES_PER_TYPE][TYPE_SELECTION_MINIONS_PER_BOSS];
