...
static const struct ScriptCommand s_gs9_g0_s0_station_sref_script[] = { /* 0x819ad18 */
  ...
  LABEL(52), /* = 0x34 */
    ...
    JUMP_LABEL(56),
  LABEL(55), /* = 0x37 */
    SELECT_ENTITIES(0, 1),  // Changed from 7 to 1 to include Gengar and Gulpin
  LABEL(56), /* = 0x38 */
    BGM_SWITCH(1),
...
static const struct ScriptCommand s_gs9_g18_s0_lives0_dlg0[] = { /* 0x81a23fc */
    ...
    WAIT(15),
    ALERT_CUE(6),
    ROTATE(30, 10, DIRECTION_SOUTHWEST),
    AWAIT_CUE(5),
    PORTRAIT_REP(0x0001, 0x00000000),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
...
static const struct ScriptCommand s_gs9_g20_s0_lives0_dlg0[] = { /* 0x81a48c8 */
  ...
  LABEL(3), /* = 0x03 */
    ...
    SELECT_ENTITIES(-1, 2),
    AWAIT_CUE(5),
    PORTRAIT(PLACEMENT_MIDDLE_TOP_RIGHT, 0x0001, 0x00000001),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
...
static const struct ScriptCommand s_gs9_g28_s0_lives0_dlg0[] = { /* 0x81a7c70 */
    ...
    ALERT_CUE(7),
    WAIT(10),
    PORTRAIT(PLACEMENT_TOP, 0x0005, 0x00000000),
    ...
    { 0x93, 0x04,  0x000a,  0x00000022,  0x00000000, NULL },
    AWAIT_CUE(5),
    PORTRAIT(PLACEMENT_TOP_RIGHT, 0x0001, 0x00000000),
...
static const struct ScriptCommand s_gs9_g30_s0_lives0_dlg0[] = { /* 0x81acd04 */
    ...
    AWAIT_CUE(5),
    WAIT(30),
    PORTRAIT(PLACEMENT_MIDDLE_TOP_LEFT, 0x0001, 0x00000004),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    ...
    ALERT_CUE(6),
    AWAIT_CUE(5),
    PORTRAIT(PLACEMENT_MIDDLE_TOP_LEFT, 0x0001, 0x00000003),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    ...
    WAIT(10),
    ALERT_CUE(8),
    PORTRAIT(PLACEMENT_RIGHT, 0x0003, 0x00000041),
    MSG_NPC(3, _(" Yessss!\nRescue job offers!")),
    TEXTBOX_CLEAR,
    WAIT(10),
    ALERT_CUE(9),
    ...
    TEXTBOX_CLEAR,
    WAIT(10),
    PORTRAIT(PLACEMENT_LEFT_, 0x0004, 0x00000043),
    MSG_NPC(4, _(" We're a rescue team too,\nI'll have you know〜♪")),
    TEXTBOX_CLEAR,
    WAIT(10),
    PORTRAIT(PLACEMENT_RIGHT, 0x0003, 0x00000042),
    ...
    ALERT_CUE(6),
    AWAIT_CUE(5),
    PORTRAIT(PLACEMENT_LEFT_, 0x0001, 0x00000006),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" Wah!\nThis is empty!")),
...
static const struct ScriptCommand s_gs9_g31_s0_lives0_dlg0[] = { /* 0x81aee18 */
    ...
    { 0x52, 0x00,  0x0000,  0x0000001f,  0x00000000, NULL },
    ALERT_CUE(6),
    PORTRAIT(PLACEMENT_MIDDLE_TOP_LEFT, 0x0001, 0x00000001),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
...
static const struct ScriptCommand s_gs9_g34_s0_lives0_dlg0[] = { /* 0x81b0c98 */
    ...
    ALERT_CUE(7),
    AWAIT_CUE(5),
    PORTRAIT(PLACEMENT_MIDDLE_TOP_LEFT, 0x0002, 0x00000042),
...
static const struct ScriptCommand s_gs9_g46_s0_lives0_dlg0[] = { /* 0x81ba664 */
    ...
    ALERT_CUE(6),
    WAIT(10),
    ROTATE(12, 2, DIRECTION_NORTHEAST),
    AWAIT_CUE(5),
    ...
    ALERT_CUE(6),
    AWAIT_CUE(5),
    PORTRAIT(PLACEMENT_TOP_LEFT, 0x0001, 0x00000007),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
    VARIANT(/* == */  1, _(" {NAME_0}!\nSorry!")),
    VARIANT(/* == */  3, _(" {NAME_0}!\nSorry!")),
    VARIANT_DEFAULT(_(" {NAME_0}!\nSorry!")),
...
static const struct ScriptCommand s_gs9_g48_s0_lives0_dlg0[] = { /* 0x81bb6cc */
    ...
    AWAIT_CUE(5),
    BGM_FADEOUT(150),
    PORTRAIT(PLACEMENT_MIDDLE_TOP_RIGHT_FLIP, 0x0001, 0x0000000c),
...
static const struct ScriptCommand s_gs9_g48_s0_lives1_dlg0[] = { /* 0x81bddd8 */
    ...
    AWAIT_CUE(6),
    WAIT(30),
    ROTATE(6, 1, DIRECTION_SOUTHWEST),
    WAIT(15),
...
static const struct ScriptCommand s_gs9_g53_s0_lives5_dlg0[] = { /* 0x81c1d74 */
    ...
    PORTRAIT(PLACEMENT_TOP, 0x0006, 0x00000000),
...
static const struct ScriptCommand s_gs9_g74_s0_lives0_dlg0[] = { /* 0x81ca698 */
    ...
    PORTRAIT(PLACEMENT_TOP_RIGHT, 0x0003, 0x00000041),
...
static const struct ScriptCommand s_gs9_g75_s0_lives0_dlg0[] = { /* 0x81cb8b4 */
  ...
  LABEL(15), /* = 0x0f */
    ...
    ALERT_CUE(12),
    AWAIT_CUE(5),
    PORTRAIT(PLACEMENT_TOP_RIGHT, 0x0007, 0x00000041),
    MSG_NPC(7, _(" Me too!\nI'll help too!")),
    TEXTBOX_CLEAR,
    ALERT_CUE(6),
    ALERT_CUE(7),
...
static const struct ScriptCommand s_gs9_g75_s0_lives1_dlg0[] = { /* 0x81ce8cc */
    ...
    { 0xe2, 0x00,  0x01d4,  0x00000000,  0x00000000, NULL },
    AWAIT_CUE(6),
    ROTATE(2, 1, DIRECTION_SOUTHWEST),
    AWAIT_CUE(6),
    { 0x93, 0x08,  0x000a,  0x00000000,  0x00000000, NULL },
    WAIT(1),
    ALERT_CUE(5),
...
static const struct ScriptCommand s_gs9_g76_s0_lives0_dlg0[] = { /* 0x81d041c */
    ...
    PORTRAIT(PLACEMENT_RIGHT, 0x0002, 0x00000000),
    PORTRAIT(PLACEMENT_TOP_RIGHT, 0x0003, 0x00000000),
    PORTRAIT(PLACEMENT_TOP_RIGHT, 0x0007, 0x00000000),
    MSG_VAR(2, PARTNER_TALK_KIND, 1),
...
static const struct ScriptCommand s_gs9_g77_s1_lives0_dlg0[] = { /* 0x81d23bc */
  ...
  LABEL(3), /* = 0x03 */
    ...
    PORTRAIT(PLACEMENT_LEFT_, 0x0002, 0x00000000),
    AWAIT_CUE(5),
    PORTRAIT(PLACEMENT_TOP, 0x0002, 0x00000001),
    MSG_NPC(2, _(" Yes!\nA peeled Chestnut!")),
    TEXTBOX_CLEAR,
    ALERT_CUE(7),
    ALERT_CUE(8),
...
static const struct ScriptCommand s_gs9_g78_s0_lives1_dlg0[] = { /* 0x81d4d24 */
    ...
    ROTATE(10, 1, DIRECTION_WEST),
    WAIT(20),
    ROTATE(10, 2, DIRECTION_SOUTHWEST),
    WAIT(20),
    ROTATE(10, 2, DIRECTION_SOUTH),
    WAIT(20),
...
static const struct ScriptCommand s_gs9_g81_s0_lives0_dlg0[] = { /* 0x81d87d8 */
    ...
    TEXTBOX_CLEAR,
    WAIT(10),
    PORTRAIT(PLACEMENT_LEFT, 0x0001, 0x00000004),
    ...
    PORTRAIT(PLACEMENT_TOP_RIGHT, 0x0003, 0x00000003),
...
static const struct ScriptCommand s_gs9_g91_s0_lives0_dlg0[] = { /* 0x81dd410 */
    ...
    TEXTBOX_CLEAR,
    WAIT(10),
    PORTRAIT(PLACEMENT_RIGHT, 0x0002, 0x00000044),
    MSG_NPC(2, _(" ............{WAIT_PRESS}\nGood for you, {NAME_3}.")),
    TEXTBOX_CLEAR,
    WAIT(45),
    ALERT_CUE(7),
...
// Shared lives data for Gengar and Gulpin - added to all groups
static const struct GroundLivesData s_gs9_gengar_gulpin_lives[] = {
    /*  0 */ {  91,   0,   0,   0, {  63,  39, 0, CPOS_HALFTILE }, {
        [2] = s_gs9_gengar_base_dlg0,
    } },
    /*  1 */ {  76,   0,   0,   0, {  58,  39, 0, CPOS_HALFTILE }, {
        [2] = s_gs9_gulpin_base_dlg0,
    } },
};
...
static const struct GroundLivesData s_gs9_g1_s1_lives[] = { /* 0x81ddc90 */
    ...
    /*  4 */ {  91,   0,   0,   0, {  63,  39, 0, CPOS_HALFTILE }, {
        [2] = s_gs9_gengar_base_dlg0,
    } },
    /*  5 */ {  76,   0,   0,   0, {  58,  39, 0, CPOS_HALFTILE }, {
        [2] = s_gs9_gulpin_base_dlg0,
    } },
};
...
static const struct GroundLivesData s_gs9_g5_s0_lives[] = { /* 0x81ddd08 */
    ...
    {  91,   0,   0,   0, {  63,  39, 0, CPOS_HALFTILE }, {
        [2] = s_gs9_gengar_base_dlg0,
    } },
    {  76,   0,   0,   0, {  58,  39, 0, CPOS_HALFTILE }, {
        [2] = s_gs9_gulpin_base_dlg0,
    } },
};
...
static const struct GroundScriptSector s_gs9_g1_sectors[] = { /* 0x81dfd18 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, 0,NULL, 0,NULL, 1,&sStationScripts[1], },
    { LPARRAY(s_gs9_g1_s1_lives), 0,NULL, 0,NULL, 0,NULL, 0,NULL, },
};

static const struct GroundScriptSector s_gs9_g2_sectors[] = { /* 0x81dfd68 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, LPARRAY(s_gs9_g2_s0_effs), 0,NULL, 1,&sStationScripts[2], },
...
static const struct GroundScriptSector s_gs9_g3_sectors[] = { /* 0x81dfde0 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, 0,NULL, 0,NULL, 1,&sStationScripts[3], },
};

static const struct GroundScriptSector s_gs9_g4_sectors[] = { /* 0x81dfe08 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, 0,NULL, 0,NULL, 1,&sStationScripts[4], },
};
...
static const struct GroundScriptSector s_gs9_g6_sectors[] = { /* 0x81dfe80 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, LPARRAY(s_gs9_g6_s0_effs), 0,NULL, 1,&sStationScripts[6], },
...
static const struct GroundScriptSector s_gs9_g22_sectors[] = { /* 0x81e0268 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, 0,NULL, 0,NULL, 1,&sStationScripts[15], },
...
static const struct GroundScriptSector s_gs9_g24_sectors[] = { /* 0x81e0308 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), LPARRAY(s_gs9_g24_s0_objs), 0,NULL, LPARRAY(s_gs9_g24_s0_evts), 1,&sStationScripts[19], },
...
static const struct GroundScriptSector s_gs9_g41_sectors[] = { /* 0x81e0678 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, 0,NULL, 0,NULL, 1,&sStationScripts[37], },
};
...
static const struct GroundScriptSector s_gs9_g56_sectors[] = { /* 0x81e0a10 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, 0,NULL, 0,NULL, 1,&sStationScripts[53], },
};
...
static const struct GroundScriptSector s_gs9_g64_sectors[] = { /* 0x81e0ba0 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, 0,NULL, 0,NULL, 1,&sStationScripts[62], },
...
static const struct GroundScriptSector s_gs9_g66_sectors[] = { /* 0x81e0c18 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, 0,NULL, 0,NULL, 1,&sStationScripts[65], },
};
...
static const struct GroundScriptSector s_gs9_g70_sectors[] = { /* 0x81e0cb8 */
    { LPARRAY(s_gs9_gengar_gulpin_lives), 0,NULL, 0,NULL, 0,NULL, 1,&sStationScripts[69], },
};
