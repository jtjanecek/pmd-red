...
static const struct ScriptCommand s_gs223_g1_s0_station_sref_script[] = { /* 0x826dff8 - PART 1 0:00:31-0:00:45 - New game intro to personality test */
    ...
    MSG_ON_BG(_("{CENTER_ALIGN}After your selections the game\n{CENTER_ALIGN}will automatically save and restart.")),
    MSG_ON_BG(_("{CENTER_ALIGN}For more information, refer to the README\n{CENTER_ALIGN}github.com/jtjanecek/rogue-rescue-team")),
